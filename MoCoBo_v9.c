...
//Relay Pins
#define RA PORTCbits.RC4	//Relay for LEFT
#define RB PORTCbits.RC5	//Relay for RIGHT
#define RC PORTDbits.RD1	//Relay for Arm Pass
#define RD PORTEbits.RE0	//Relay for Bucket Pass 
#define RE PORTEbits.RE1	//Relay for Arm Tilt
#define RF PORTEbits.RE2	//Relay for Bucket Tilt
...
//  //Select Channel Assignments(Useful for mutiple boards tied to single TX pin)
//  if (SW6==0)
//  {
//	Channel_A=Channel_A_ID1;
//	Channel_B=Channel_B_ID1;
//	Channel_C=Channel_C_ID1;
//	Channel_D=Channel_D_ID1;
//  }
//  else
//  {
//	Channel_A=Channel_A_ID2;
//	Channel_B=Channel_B_ID2;
//	Channel_C=Channel_C_ID2;
//	Channel_D=Channel_D_ID2;
//  }

  //Check switch position 7 and jump to Master or Slave mode
  if (SW7==0)
    trackmode();	//master();
  else
    bucket();		//slave();
