...
if("TRUE" STREQUAL "TRUE")
  set(rigid_body_handler_SOURCE_PREFIX /home/carl/LunaBot/2015/catkin_ws/src/vrep_ros_bridge/rigid_body_handler)
  set(rigid_body_handler_DEVEL_PREFIX /home/carl/LunaBot/2015/catkin_ws/devel)
  ...
  set(rigid_body_handler_INSTALL_PREFIX /home/carl/LunaBot/2015/catkin_ws/install)
...
if(NOT "/home/carl/LunaBot/2015/catkin_ws/src/vrep_ros_bridge/rigid_body_handler/include" STREQUAL "")
  set(rigid_body_handler_INCLUDE_DIRS "")
  set(_include_dirs "/home/carl/LunaBot/2015/catkin_ws/src/vrep_ros_bridge/rigid_body_handler/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rigid_body_handler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/carl/LunaBot/2015/catkin_ws/src/vrep_ros_bridge/rigid_body_handler/${idir}'.  Ask the maintainer 'Giovanni Claudio <giovanni.claudio@inria.fr>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rigid_body_handler_dep}_FOUND)
      find_package(${rigid_body_handler_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rigid_body_handler_dep} REQUIRED ${depend_list})
  endif()
